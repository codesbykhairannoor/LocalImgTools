...
const translations = {
  en: {
    ...
    featuresTitle: "Why Local Img Tools?",
    ...
    faq1Q: "Does Local Img Tools upload my photos?",
    faq1A: "No, never. Local Img Tools uses HTML5 and WebAssembly APIs to process your files locally in your browser. Your images stay on your device.",
  ...
  id: {
    ...
    featuresTitle: "Mengapa Local Img Tools?",
    ...
    faq1Q: "Apakah Local Img Tools mengunggah foto saya?",
    faq1A: "Tidak, sama sekali tidak. Local Img Tools menggunakan API HTML5 dan WebAssembly untuk memproses file Anda secara lokal di browser. Gambar Anda tetap di perangkat Anda.",
  ...
  es: {
    ...
    featuresTitle: "¿Por qué Local Img Tools?",
    ...
    faq1Q: "¿Local Img Tools sube mis fotos?",
    faq1A: "No, nunca. Local Img Tools utiliza las API de HTML5 y WebAssembly para procesar sus archivos localmente en su navegador. Sus imágenes permanecen en su dispositivo.",
  ...
  fr: {
    ...
    featuresTitle: "Pourquoi Local Img Tools ?",
    ...
    faq1Q: "Est-ce que Local Img Tools télécharge mes photos ?",
    faq1A: "Non, jamais. Local Img Tools utilise les API HTML5 et WebAssembly pour traiter vos fichiers localement. Vos images restent sur votre appareil.",
  ...
  de: {
    ...
    featuresTitle: "Warum Local Img Tools?",
    ...
    faq1Q: "Lädt Local Img Tools meine Fotos hoch?",
    faq1A: "Nein, niemals. Local Img Tools nutzt HTML5- und WebAssembly-APIs, um Ihre Dateien lokal im Browser zu verarbeiten. Ihre Bilder bleiben auf Ihrem Gerät.",
  ...
  pt: {
    ...
    featuresTitle: "Por que o Local Img Tools?",
    ...
    faq1Q: "O Local Img Tools faz upload das minhas fotos?",
    faq1A: "Não, nunca. O Local Img Tools usa APIs HTML5 e WebAssembly para processar arquivos localmente no navegador. Suas imagens permanecem no seu dispositivo.",
